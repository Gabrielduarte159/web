...
export function Confirm(){
  ...
  if(!location.state?.fromSubit){
    return <Navigate to="/"/>
  }
  return(
    <div className="bg-gray-500 lg:w-lg rounded-xl flex flex-col items-center p-10 gap-6">
      <h1 className="text-2x6 font-bold text-center text-green-100">Solicitação enviada!</h1>
      <img src={okSvg} alt="Ícone de OK" className="w-28" />
      <p className="text-sm text-gray-200 text-center">
        Agora é apenas aguardar! Sua solicitação será analisada e em breve o setor financeiro contatará você
      </p>
